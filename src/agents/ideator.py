...
Given a research brief, generate {config.IDEAS_PER_RUN} post ideas that will
get ENGAGEMENT on Vishal's profile and pull in his ideal audience.

AUDIENCE: {b['audience']['primary']}
Pains:
{pains}
OFFERS (inform the angle, don't recite):
{offers}

RULES FOR EACH IDEA
- CONCRETE, ready-to-write. Not "post about AI automation" but
  "Break down the exact 3-step n8n flow that replaced a client's $3k/mo VA,
   with the hour-by-hour time breakdown."
- Tie each to a specific audience pain.
- Score 1-10 for engagement potential (be honest; reserve 9-10 for bangers).
- Pick a format: story | framework | hot_take | case_study | question | bts | lesson
- platform_fit: "linkedin" | "x" | "both"
- Do NOT repeat the recent ideas/posts listed below.
...
{{
  "ideas": [
    {{
      ...
      "why": "one sentence on why this earns engagement",
      "score": 8.5,
      "platform_fit": "both"
    }}
  ]
