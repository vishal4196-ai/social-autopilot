...
# Public origin for building absolute URLs outside a request context
# (e.g. image URLs generated by the chat agent's draft tool).
PUBLIC_BASE_URL = _env("PUBLIC_BASE_URL", "https://worker-production-d65d.up.railway.app")
